"""
TRAINING - LINEAR REGRESSION (3x3 MATRIX METHOD)
"""
...
# ================================
def train_linear_regression(save_model=True):
    """
    Train a Linear Regression model using preprocessed data (3x3 matrix transformation).

    Args:
        save_model (bool): Whether to save the trained model.

    Returns:
        tuple: (lr_model, X_test, y_test, y_pred)
    """
    # Load data
...
# 3. Model Evaluation
# ================================
def evaluate_linear_regression(y_test, y_pred):
    """
